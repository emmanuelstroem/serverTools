...
# sudo -u postgres psql -c "CREATE ROLE joyeriasenmonterrey LOGIN UNENCRYPTED PASSWORD 'secret' SUPERUSER INHERIT NOCREATEDB NOCREATEROLE NOREPLICATION;"
# sudo -u postgres /usr/bin/createdb --echo --owner=joyeriasenmonterrey joyeriasenmonterrey
...
DB_HOST=127.0.0.1
DB_PORT=3306
DB_DATABASE=joyeriasenmonterrey
DB_USERNAME=joyeriasenmonterrey
DB_PASSWORD=secret
#
