...
printf "\nPATH=\"$(sudo su - grimlock -c 'composer config -g home 2>/dev/null')/vendor/bin:\$PATH\"\n" | tee -a /home/grimlock/.profile

# Install Laravel Envoy & Installer

sudo su grimlock <<'EOF'
...
#Git setup
#sudo git clone https://eviltwin591:paul256wing@bitbucket.org/eviltwin591/sp_analysis.git /var/www/html/sp_analysis


#Create .env
cat >/var/www/html/sp_analysis/.env <<EOL
APP_NAME=""
APP_ENV=local
APP_KEY=base64:7BEwD92ipAbwxYflBjre9OBYFtLbVsqtVE+kkY7we/4=
APP_DEBUG=true
APP_LOG_LEVEL=debug
...
ROLLBAR_TOKEN=d61451656d7645f3a59f9056814641ee
ROLLBAR_LEVEL=debug
EOL
cat /var/www/html/sp_analysis/.env

#composer install
sudo composer install -d /var/www/html/sp_analysis
...
server {
    ...
    root /var/www/joyeriasenmonterrey.com;
...
#Set permissions
sudo chgrp -R www-data /var/www/html/sp_analysis
sudo chmod -R 775 /var/www/html/sp_analysis/storage
sudo chmod -R 775 /var/www/html/sp_analysis/bootstrap
